...
public class JoinOptimizer {
	 ...
	 * here -- because DbIterator's don't provide any cardinality estimates, and
	 ...
	 * the amount of data that must be read over the course of the query, as well as
	 * the number of CPU opertions performed by your join. Assume that the cost of a
	 ...
	 *              side of the query，我认为这个cost应该算上了磁盘搜索与磁盘传输的成本
	...
	public static int estimateTableJoinCardinality(Predicate.Op joinOp, String table1Alias, String table2Alias,
		...
		// 确定大小表的size
		int samll = card1 < card2 ? card1 : card2;
		int big = card1 > card2 ? card1 : card2;
